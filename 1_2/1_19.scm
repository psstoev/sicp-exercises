...
;; applying Tn, the n th power of the transformation T, starting with
...
;; the same as using a single transformation Tpq of the same form, and
;; compute p and q in terms of p and q. This gives us an explicit way
;; to square these transformations, and thus we can compute Tn using
